 ...
 * @public
 */
export declare class InngestFunction<ID extends string, TFnOpts extends InngestFunction.Options<ID, TClient, TMiddleware, TTriggers, TFailureHandler>, THandler extends Handler.Any, TFailureHandler extends Handler.Any, TClient extends Inngest.Any = Inngest.Any, TMiddleware extends InngestMiddleware.Stack = InngestMiddleware.Stack, TTriggers extends InngestFunction.Trigger<TriggersFromClient<TClient>>[] = InngestFunction.Trigger<TriggersFromClient<TClient>>[]> implements InngestFunction.Like {
...
export declare namespace InngestFunction {
     ...
     * inference.
     */
    type Any<ID extends string = string> = InngestFunction<ID, any, Handler.Any, Handler.Any, any, any, any>;
    interface Like {
        name: string;
