...
export declare class Inngest<TClientOpts extends ClientOptions = ClientOptions> implements Inngest.Like {
    ...
    get funcs(): InngestFunction.Any<string>[];
...
export declare namespace Inngest {
    ...
    type CreateFunction<TClient extends Inngest.Any> = <TMiddleware extends InngestMiddleware.Stack, TTrigger extends SingleOrArray<InngestFunction.Trigger<TriggersFromClient<TClient>>>, THandler extends Handler.Any = Handler<TClient, EventNameFromTrigger<GetEvents<TClient, true>, AsArray<TTrigger>[number]>, ExtendWithMiddleware<[
        ...
        NonNullable<ClientOptionsFromInngest<TClient>["middleware"]>,
        TMiddleware
    ], FailureEventArgs<GetEvents<TClient, true>[EventNameFromTrigger<GetEvents<TClient, true>, AsArray<TTrigger>[number]>]>>>, ID extends string = string>(options: Omit<InngestFunction.Options<ID, TClient, TMiddleware, AsArray<TTrigger>, TFailureHandler>, "triggers">, trigger: TTrigger, handler: THandler) => InngestFunction<ID, InngestFunction.Options<ID, TClient, TMiddleware, AsArray<TTrigger>, TFailureHandler>, THandler, TFailureHandler, TClient, TMiddleware, AsArray<TTrigger>>;
}
/**
 ...
 * @internal
 */
export type GetFunctionOutputFromInngestFunction<TFunction extends InngestFunction.Any> = TFunction extends InngestFunction<any, any, infer IHandler, any, any, any> ? IsNever<SimplifyDeep<Jsonify<Awaited<ReturnType<IHandler>>>>> extends true ? null : SimplifyDeep<Jsonify<Awaited<ReturnType<IHandler>>>> : unknown;
/**
